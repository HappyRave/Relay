...
These work from any app, even when the widget is hidden.

| Shortcut | Idle | While recording | While playing |
| --- | --- | --- | --- |
...
| Hotkey field | <kbd>Backspace</kbd> | Clears the hotkey |
| Hotkey field | <kbd>Esc</kbd> | Cancels |
| Export dialog | <kbd>Esc</kbd> | Closes the dialog |
| Anywhere | <kbd>Tab</kbd> / <kbd>Shift</kbd>+<kbd>Tab</kbd> | Moves between controls |
